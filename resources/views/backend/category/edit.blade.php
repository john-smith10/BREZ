            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <select class="js-example-basic-single form-control" name="state">
                        ...
                        @foreach ($allCategory as $category)
                            <option {{ $category->id == $edit_category->parent_id ? 'selected' : ''}} value="{{ $category->id }}" {{ old('state') == $category->id ? 'selected' : '' }}>
                                {{ $category->title }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-lg-4 mb-3">
                    ...
                    <select name="status" class="form-control p-3">
                        ...
                        <option value="1" {{ $edit_category->status == '1' ? 'selected' : '' }}>Active</option>
                        <option value="0" {{ $edit_category->status == '0' ? 'selected' : '' }}>Inactive</option>
                    </select>
                    @error('status')
                        <p class="text-danger mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div class="col-lg-4 mb-3">
                    ...
                    <input type="text" name="meta_des" id="meta_des" class="form-control p-3" 
                           placeholder="meta description" value="{{ $edit_category->meta_description }}">
                </div>

                <div class="col-lg-4 mb-3">
                    <label for="meta_title">Meta Title</label>
                    <input value="{{ $edit_category->meta_title }}" type="text" name="meta_title" id="meta_title" class="form-control p-3" 
                ...
                <div class="col-lg-6 mb-3">
                 ...
                 <div class="col-lg-6 mb-3">
                    ...
                    {{-- <img class="mt-1" src="{{ asset('placeholder.jpg') }}" alt="">  --}}
                    <img 
                       class="mt-1 img-thumbnail"
                         width="200"
                           src="{{ $edit_category->meta_image 
                         ? asset('storage/category/' . $edit_category->meta_image) 
